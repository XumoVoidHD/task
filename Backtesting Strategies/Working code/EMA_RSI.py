...
class EMA_RSI(Strategy):
    ...
    def init(self):
        ...
        self.rsi = self.I(talib.RSI, price, timeperiod=self.rsi_timeperiod)
...
if __name__ == "__main__":
    ...
    if multi_threading:
        ...
        it = 0
        start_time = time.time()
        files = os.listdir("C:/Users/vedan/PycharmProjects/task/Backtesting Strategies/dataa")
        for file in files:
    ...
    if convert_to_excel:
        ...
        for i in range(0, len(results)):
            ...
            ema_long.append(results[i][28])
            ema_short.append(results[i][29])
        existing_data = {
