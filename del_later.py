...
class Client:
    ...
    def __init__(self):
        self.api_key = "4280d308-636d-4e61-b0a2-aaa18f78daf3"
        self.api_secret = "lWlPr6RDwroL66u-l9CfYEhp4J8HyBlOT7ldAGWquSEwY2RkMjU1Zi0wOTRlLTQ4OGMtODMxZS1iZGU1N2ZjM2YyZGY"
...
# params = {
#     "symbol": "BTCUSD", "clOrdID": f"uuid-{timestamp}", "side": "Sell", "priceEp": 93185000, "orderQty": 7,
#     "ordType": "Limit", "reduceOnly": "false", "timeInForce": "GoodTillCancel", "takeProfitEp": 0, "stopLossEp": 0
# }
# print(wrap.place_order(params=params).json())
